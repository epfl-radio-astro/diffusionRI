...
from helpers import rgz_transform_real, first_radio_galaxy_transform_real
...
def train_dataset():
    ...
    data = FIRSTGalaxyData(root="./data/FIRST/", selected_split="train", selected_classes=["FRI", "FRII", "Compact", "Bent"], input_data_list=["galaxy_data_h5.h5"],
                           is_PIL=False, is_RGB=True, transform=first_radio_galaxy_transform_real)
    ds = RGZ20k('./data/rgz20', download=True, transform=rgz_transform_real)

    return ConcatDataset([ds, data])
